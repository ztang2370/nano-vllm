...
from nanovllm.engine.op_replica import ReplicaConfig, ReplicaManager
from nanovllm.engine.scheduler import Scheduler
from nanovllm.engine.sequence import Sequence
from nanovllm.layers.linear import RowParallelLinear
from nanovllm.models.qwen3 import set_linear_replica_manager
...
class LLMEngine:
    ...
    def __init__(self, model, **kwargs):
        ...
        # Set replica manager in the model for linear layers to use BEFORE creating ModelRunner
        ...
        if "down_proj" in config.op_replica_configs:
            ...
            for layer_id in range(num_layers):
                ...
                self.replica_manager.create_replicas(
                    ...
                    weight_config=down_proj_config,  # Pass full config including constructor params
